...
SchemaFor200ResponseBodyApplicationJson = SyncFinancialConnectionsDataResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _sync_financial_connections_data_oapg(
        self,
...
class SyncFinancialConnectionsData(BaseApi):
