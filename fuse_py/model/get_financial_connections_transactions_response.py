...
class GetFinancialConnectionsTransactionsResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["transactions", "total_transactions", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["transactions", "total_transactions", "request_id", ], str]):
    ...
    def __new__(
        ...
        *_args: typing.Union[dict, frozendict.frozendict, ],
        total_transactions: typing.Union[MetaOapg.properties.total_transactions, decimal.Decimal, int, float, ],
