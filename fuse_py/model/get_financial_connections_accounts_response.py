...
class GetFinancialConnectionsAccountsResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["accounts", "financial_connection", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["accounts", "financial_connection", "request_id", ], str]):
