...
class DeleteFinancialConnectionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["financial_connection_id", "access_token", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["financial_connection_id", "access_token", "request_id", ], str]):
