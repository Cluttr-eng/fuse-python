...
class GetFinancialInstitutionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["financial_institution", "request_id", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["financial_institution"]) -> 'FinancialInstitution': ...
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["financial_institution", "request_id", ], str]):
