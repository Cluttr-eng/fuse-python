...
class ExchangeFinancialConnectionsPublicTokenRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["public_token", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["public_token", ], str]):
