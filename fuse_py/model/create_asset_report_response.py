...
class CreateAssetReportResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "asset_report_id", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["asset_report_token", "asset_report_id", "request_id", ], str]):
