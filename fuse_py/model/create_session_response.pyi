...
class CreateSessionResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["expiration", "client_secret", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["expiration", "client_secret", "request_id", ], str]):
