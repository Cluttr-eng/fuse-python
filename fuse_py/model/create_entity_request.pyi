...
class CreateEntityRequest(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "email", "aggregators", "institution_ids", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "email", "aggregators", "institution_ids", ], str]):
