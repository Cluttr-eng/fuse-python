...
class FinancialConnectionData(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["id", "institution_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["id", "institution_id", ], str]):
