...
class CreateLinkTokenResponse(
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["link_token", "request_id", ], str]):
    ...
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["link_token", "request_id", ], str]):
