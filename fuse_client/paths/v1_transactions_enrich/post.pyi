...
# body param
SchemaForRequestBodyApplicationJson = EnrichTransactionsRequest


request_body_enrich_transactions_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = EnrichTransactionsResponse
...
class BaseApi(api_client.Api):
    ...
    def _enrich_transactions_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_enrich_transactions_request.serialize(body, content_type)
...
class EnrichTransactions(BaseApi):
    ...
    def enrich_transactions(
        ...
        return self._enrich_transactions_oapg(
            body=body,
