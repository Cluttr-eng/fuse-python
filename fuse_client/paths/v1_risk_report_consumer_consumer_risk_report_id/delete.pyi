...
SchemaFor200ResponseBodyApplicationJson = DeleteConsumerRiskReportResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _delete_consumer_risk_report_oapg(
        self,
...
class DeleteConsumerRiskReport(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def delete_consumer_risk_report(
        self,
        header_params: RequestHeaderParams = frozendict.frozendict(),
        path_params: RequestPathParams = frozendict.frozendict(),
        accept_content_types: typing.Tuple[str] = _all_accept_content_types,
    ...
    def delete_consumer_risk_report(
        ...
        return self._delete_consumer_risk_report_oapg(
