...
# body param
SchemaForRequestBodyApplicationJson = AddSpendPowerTransactionRequest


request_body_add_spend_power_transaction_request = api_client.RequestBody(
    content={
...
SchemaFor200ResponseBodyApplicationJson = AddSpendPowerTransactionResponse
...
class BaseApi(api_client.Api):
    @typing.overload
    def _add_spend_power_transaction_oapg(
        self,
    ...
    def _add_spend_power_transaction_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_spend_power_transaction_request.serialize(body, content_type)
...
class AddSpendPowerTransaction(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_spend_power_transaction(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def add_spend_power_transaction(
        ...
        return self._add_spend_power_transaction_oapg(
            body=body,
