...
SchemaFor200ResponseBodyApplicationJson = GetFinanceScoreResponse
...
class GetFinanceScore(BaseApi):
    ...
    def get_finance_score(
        ...
        return self._get_finance_score_oapg(
