...
# body param
SchemaForRequestBodyApplicationJson = AddAccountEventsRequest


request_body_add_account_events_request = api_client.RequestBody(
    content={
        'application/json': api_client.MediaType(
            schema=SchemaForRequestBodyApplicationJson),
    },
)
SchemaFor200ResponseBodyApplicationJson = AddAccountEventsResponse
...
class BaseApi(api_client.Api):
    ...
    def _add_account_events_oapg(
        ...
        if body is not schemas.unset:
            serialized_data = request_body_add_account_events_request.serialize(body, content_type)
...
class AddAccountEvents(BaseApi):
    # this class is used by api classes that refer to endpoints with operationId fn names

    @typing.overload
    def add_account_events(
        self,
        content_type: typing_extensions.Literal["application/json"] = ...,
        body: typing.Union[SchemaForRequestBodyApplicationJson, schemas.Unset] = schemas.unset,
        path_params: RequestPathParams = frozendict.frozendict(),
    ...
    def add_account_events(
        ...
        return self._add_account_events_oapg(
            body=body,
