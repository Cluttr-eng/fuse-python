...
class EnrichTransactionsResponse(
                ...
                class MetaOapg:
                    ...
                    class items(
                        ...
                        class MetaOapg:
                            ...
                            class properties:
                                enhanced_name = schemas.StrSchema
                        ...
                        @typing.overload
                        def __getitem__(self, name: typing_extensions.Literal["enhanced_name"]) -> MetaOapg.properties.enhanced_name: ...
                        ...
                        def __getitem__(self, name: typing.Union[typing_extensions.Literal["enhanced_name", "original_name", "logo", "amount", "category", "is_bill_pay", "is_direct_deposit", "is_expense", "is_fee", "is_income", "is_international", "is_overdraft_fee", "is_payroll_advance", "is_subscription", "type", ], str]):
                            # dict_instance[name] accessor
                            return super().__getitem__(name)
                        
                        
                        @typing.overload
                        def get_item_oapg(self, name: typing_extensions.Literal["enhanced_name"]) -> typing.Union[MetaOapg.properties.enhanced_name, schemas.Unset]: ...
                        ...
                        def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enhanced_name", "original_name", "logo", "amount", "category", "is_bill_pay", "is_direct_deposit", "is_expense", "is_fee", "is_income", "is_international", "is_overdraft_fee", "is_payroll_advance", "is_subscription", "type", ], str]):
                            return super().get_item_oapg(name)
                        ...
                        def __new__(
                            cls,
                            *_args: typing.Union[dict, frozendict.frozendict, ],
                            enhanced_name: typing.Union[MetaOapg.properties.enhanced_name, str, schemas.Unset] = schemas.unset,
    ...
    def __getitem__(self, name: typing.Union[typing_extensions.Literal["enriched_transactions", ], str]):
        # dict_instance[name] accessor
        return super().__getitem__(name)
    
    
    @typing.overload
    def get_item_oapg(self, name: typing_extensions.Literal["enriched_transactions"]) -> typing.Union[MetaOapg.properties.enriched_transactions, schemas.Unset]: ...
    
    @typing.overload
    def get_item_oapg(self, name: str) -> typing.Union[schemas.UnsetAnyTypeSchema, schemas.Unset]: ...
    
    def get_item_oapg(self, name: typing.Union[typing_extensions.Literal["enriched_transactions", ], str]):
        return super().get_item_oapg(name)
    ...
    def __new__(
        cls,
        *_args: typing.Union[dict, frozendict.frozendict, ],
        enriched_transactions: typing.Union[MetaOapg.properties.enriched_transactions, list, tuple, schemas.Unset] = schemas.unset,
        _configuration: typing.Optional[schemas.Configuration] = None,
        **kwargs: typing.Union[schemas.AnyTypeSchema, dict, frozendict.frozendict, str, date, datetime, uuid.UUID, int, float, decimal.Decimal, None, list, tuple, bytes],
