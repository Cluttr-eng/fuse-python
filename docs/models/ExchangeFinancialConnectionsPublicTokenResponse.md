...
------------ | ------------- | ------------- | ------------- | -------------
**access_token** | str,  | str,  | Token used for querying data on the user | 
**financial_connection_id** | str,  | str,  | The id of the new financial connection. Every webhook will be sent with this id. | 
